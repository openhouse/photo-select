...
const testFiles = ['tests/integratedSelection.test.js', 'tests/curatorialContext.test.js', 'tests/curatorialContextExport.test.js', 'tests/curatorialPacket.test.js', 'tests/curatorialPacketBuild.test.js', 'tests/knowledgeContext.test.js', 'tests/liveExploration.test.js', 'tests/knowledgeLive.test.js', 'tests/knowledgeRun.test.js', 'tests/cliKnowledge.test.js', 'tests/knowledgeOrchestrator.test.js', 'tests/curationExploration.test.js', 'tests/githubBridge.test.js', 'tests/githubCuration.test.js', 'tests/githubReplyRepair.test.js', 'tests/githubPromptParity.test.js', 'tests/githubOriginalContract.test.js', 'tests/githubContextPrompt.test.js', 'tests/githubBatch.test.js', 'tests/githubPromptCache.test.js', 'tests/githubCacheTokenCount.test.js', 'tests/githubCacheRecovery.test.js', 'tests/githubFlex.test.js', 'tests/githubReliability.test.js', 'tests/githubRun.test.js', 'tests/knowledgeLauncher.test.js', 'tests/cliGithub.test.js', 'tests/cliPrivateOutput.test.js', 'tests/cliGithubWorkflow.test.js', 'tests/githubCanary.test.js'];
...
try {
  ...
  const report = { schemaVersion: 1, scope: 'offline-contract-and-implementation', candidate: before,
    behaviorPreservation: { status: 'passed', referenceCommit: 'f7a5a01dfc7badddbec9841df91a24d88d11d27c',
      authorizedPromptChange: '2026-09-11: one conditional GitHub exploration invitation; all other historical instructions preserved',
      suites: ['tests/githubContextPrompt.test.js', 'tests/githubOriginalContract.test.js', 'tests/githubPromptParity.test.js', 'tests/cliGithubWorkflow.test.js'] },
