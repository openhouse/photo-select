...
Inspect relevant branch lists and commit dates, paginate where needed, and compare recent branch editions. Prefer reading files at a resolved commit SHA, citing the verified URL and branch/ref. The newest branch is not necessarily adopted and sibling branches are not cumulative. Be candid about coverage and missing reads; never claim you read everything.
